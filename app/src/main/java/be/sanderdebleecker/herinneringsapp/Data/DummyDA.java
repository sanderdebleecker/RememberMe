...
public class DummyDA extends BaseRepository {
    ...
    private int insertAlbum(Album newAlbum) {
        ...
        try{
            ...
            cv.put(MemoriesDbHelper.AlbumColumns.AlbumThumbnail.toString(), newAlbum.getThumbnail().getUuid());
            //execute
    ...
    private List<User> createUsers() {
        ...
        User u1 = new User();
        u1.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
        ...
        User u2 = new User();
        u2.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
        u2.setFirstName("Mia");
        ...
        User u3 = new User();
        u3.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
    ...
    private List<Album> createAlbums() {
        ...
        a1.setName("Album 1");
        a1.setAuthorId(3);
        a1.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
        Album a2 = new Album();
        a2.setName("Album 2");
        a2.setAuthorId(3);
        a2.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
        Album a3 = new Album();
        a3.setName("Album 3");
        a3.setAuthorId(1);
        a3.setUuid(UUID.randomUUID().toString().replaceAll("-",""));
